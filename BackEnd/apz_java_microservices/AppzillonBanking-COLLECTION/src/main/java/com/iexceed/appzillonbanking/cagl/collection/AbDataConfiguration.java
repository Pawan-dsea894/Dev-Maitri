...
public class AbDataConfiguration {
	...
	public DataSource dataSource() {
		...
		HikariDataSource hikariDataSource = DataSourceBuilder.create().type(HikariDataSource.class)
				.url(getDatasourceProperties().getUrl()).username(getDatasourceProperties().getUsername())
				.password(decryptedPassword).driverClassName(getDatasourceProperties().getDriverClassName()).build();
	...
	public LocalContainerEntityManagerFactoryBean barEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(abDataSource)
				...
				.persistenceUnit("abdata").properties(getJpaProperties(springJpaProperties)).build();
	}
