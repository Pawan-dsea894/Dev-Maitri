...
@Repository
public interface KendraIdsLatLongRepository extends JpaRepository<KendraLatLongEntity, Integer> {
	...
	List<KendraIdsLatLongProjection> findByKendraIds(@Param("kendraIds") List<Integer> kendraIds);
}
