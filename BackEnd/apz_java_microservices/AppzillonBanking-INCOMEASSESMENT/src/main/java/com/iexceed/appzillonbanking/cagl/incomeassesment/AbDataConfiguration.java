...
@EnableJpaRepositories(entityManagerFactoryRef = "abEntityManagerFactory", transactionManagerRef = "abTransactionManager", basePackages = {
		"com.iexceed.appzillonbanking.cagl.repository.ab", "com.iexceed.appzillonbanking.cagl.*.repository.ab",
		"com.iexceed.appzillonbanking.*.repository.ab", "com.iexceed.appzillonbanking.cagl.*.repository.ab",
		"com.iexceed.appzillonbanking.cagl.repository.cus", "com.iexceed.appzillonbanking.cagl.incomeassesment.core.*"})
	...
	public LocalContainerEntityManagerFactoryBean barEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(abDataSource)
				.packages("com.iexceed.appzillonbanking.*.domain.ab", "com.iexceed.appzillonbanking.cagl.domain.ab",
						...
						"com.iexceed.appzillonbanking.cagl.*.domain.ab", "com.iexceed.appzillonbanking.cagl.domain.cus",
						"com.iexceed.appzillonbanking.cagl.entity", "com.iexceed.appzillonbanking.cagl.incomeassesment.core.*")
