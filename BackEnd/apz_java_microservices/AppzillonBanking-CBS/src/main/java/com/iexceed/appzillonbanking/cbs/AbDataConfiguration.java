...
@EnableJpaRepositories(entityManagerFactoryRef = "abEntityManagerFactory", transactionManagerRef = "abTransactionManager", basePackages = {
		"com.iexceed.appzillonbanking.cbs.repository.ab", "com.iexceed.appzillonbanking.cbs.*.repository.ab",
		"com.iexceed.appzillonbanking.*.repository.ab", "com.iexceed.appzillonbanking.cbs.*.repository.ab",
		"com.iexceed.appzillonbanking.cbs.repository.cus" })
public class AbDataConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean barEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(abDataSource)
				.packages("com.iexceed.appzillonbanking.*.domain.ab", "com.iexceed.appzillonbanking.cbs.domain.ab",
						"com.iexceed.appzillonbanking.cbs.*.domain.ab",
						"com.iexceed.appzillonbanking.cbs.*.domain.ab", "com.iexceed.appzillonbanking.cbs.domain.cus",
						"com.iexceed.appzillonbanking.cbs.entity")
