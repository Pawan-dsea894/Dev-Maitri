...
@EnableJpaRepositories(entityManagerFactoryRef = "abEntityManagerFactory", transactionManagerRef = "abTransactionManager", basePackages = {
		"com.iexceed.appzillonbanking.kendra.repository.ab", "com.iexceed.appzillonbanking.kendra.*.repository.ab",
		"com.iexceed.appzillonbanking.*.repository.ab", "com.iexceed.appzillonbanking.kendra.*.repository.ab",
		"com.iexceed.appzillonbanking.kendra.repository.cus" })
public class AbDataConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean barEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(abDataSource)
				.packages("com.iexceed.appzillonbanking.*.domain.ab", "com.iexceed.appzillonbanking.kendra.domain.ab",
						"com.iexceed.appzillonbanking.kendra.*.domain.ab",
						"com.iexceed.appzillonbanking.kendra.*.domain.ab", "com.iexceed.appzillonbanking.kendra.domain.cus",
						"com.iexceed.appzillonbanking.kendra.entity")
