...
public class ApplicationWorkflow {
	...
	public String toString() {
		return "ApplicationWorkflow [appId=" + appId + ", applicationId=" + applicationId + ", versionNum=" + versionNum
				+ ", workflowSeqNum=" + workflowSeqNum + ", createdBy=" + createdBy + ", createdUserName="
				+ createdUserName + ", createTs=" + createTs + ", applicationStatus=" + applicationStatus + ", remarks="
				+ remarks + ", currentRole=" + currentRole + ", nextWorkFlowStage=" + nextWorkFlowStage + "]";
	}
}