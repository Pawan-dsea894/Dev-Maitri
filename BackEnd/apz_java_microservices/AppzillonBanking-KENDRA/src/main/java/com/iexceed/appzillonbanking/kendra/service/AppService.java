...
import com.iexceed.appzillonbanking.kendra.repository.cus.KendraRepo;
...
public class AppService {
	...
	public List<KendraManagementEntity> getExculedList(String kmid)
	{
		List<String> kList = new ArrayList<String>();
		kList.add(kmid);
		kList.add(assignedSatus);
		return repo.fetchKendraMangerAsignListExclude(kList);
	}
