...
@EnableJpaRepositories(entityManagerFactoryRef = "abEntityManagerFactory", transactionManagerRef = "abTransactionManager", basePackages = {
		"com.iexceed.appzillonbanking.cagl.repository.ab", "com.iexceed.appzillonbanking.cagl.*.repository.ab","com.iexceed.appzillonbanking.cagl.loan.bulkupload.repository.ab",
		"com.iexceed.appzillonbanking.*.repository.ab", "com.iexceed.appzillonbanking.cagl.*.repository.ab", "com.iexceed.appzillonbanking.cagl.loan.bulkupload.domain.ab",
...
public class AbDataConfiguration {
	...
	private long springmaxLifeTime;
...
//	}
	...
	public DataSource dataSource() {
	    ...
	    hikariDataSource.setMaxLifetime(springmaxLifeTime);
	...
	public LocalContainerEntityManagerFactoryBean barEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(abDataSource)
				.packages("com.iexceed.appzillonbanking.*.domain.ab", "com.iexceed.appzillonbanking.cagl.domain.ab",
						"com.iexceed.appzillonbanking.cagl.*.domain.ab", "com.iexceed.appzillonbanking.cagl.loan.bulkupload.repository.ab",
						"com.iexceed.appzillonbanking.cagl.*.domain.ab", "com.iexceed.appzillonbanking.cagl.domain.cus","com.iexceed.appzillonbanking.cagl.loan.bulkupload.domain.ab",
