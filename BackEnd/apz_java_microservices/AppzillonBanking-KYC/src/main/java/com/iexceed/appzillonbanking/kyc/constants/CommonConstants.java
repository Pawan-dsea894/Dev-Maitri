package com.iexceed.appzillonbanking.kyc.constants;
...
public class CommonConstants {
	...
	public static final String DEDUPE_MOBILE = "mobile";
	public static final String DEDUPE_KYCID = "kyc";
	public static final String DEDUPE_BANK = "bank";
	public static final String OCR_AADHAR = "Aadhar";
	public static final String OCR_PAN = "Pan";
	public static final String OCR_VOTER = "Voter";
